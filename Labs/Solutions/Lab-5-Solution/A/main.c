...
int main() {
    ...
    count = countInStock(vm);
    if(count != 3) {
        verrf("countInStock returned %d, expected %d", count, 3);
    }
    ...
    count = countInStock(vm);
    if(count != 2) {
        verrf("countInStock returned %d, expected %d", count, 2);
    }
